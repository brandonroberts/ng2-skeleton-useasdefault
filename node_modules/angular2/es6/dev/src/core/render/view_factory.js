...
export function createRenderView(fragmentCmds, inplaceElement, nodeFactory) {
    ...
    view = new DefaultRenderView(fragments, context.boundTextNodes, context.boundElements, context.nativeShadowRoots, context.globalEventAdders);
    return view;
}
class BuildContext {
...
class Component {
    constructor(hostElement, shadowRoot, cmd) {
